...
public class MultiCortex implements Runnable {
    ...
    public MultiCortex(Application app) {
        ...
        //1st zone
        layer_1 = new LayerWLearning("1й", this, 2, 2, 5, 12, //120, 120, //160, 120,
            new Mapping[]{
        ...
        layer_2 = new LayerWLearning("2й", this, 2, 2, 1, 1, //120, 120, //160, 120,
            new Mapping[]{
                new MappingSOM(layer_1, 4, 1, 4) //7x7 (50)
            },
            LearningSOM.class
        );
