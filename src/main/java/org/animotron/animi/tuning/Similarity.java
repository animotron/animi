...
import static org.animotron.matrix.MatrixDelay.noAttenuation;
import static org.animotron.matrix.MatrixDelay.oneStepAttenuation;
...
public class Similarity extends Controller {
    ...
    public Similarity(Application app) {
    	...
    	layer_1b = new LayerWLearning("similarity", app, Codes.SHIFTS, Codes.CODES, 1,
            new Mapping[]{
