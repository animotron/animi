 ...
 *
 */
public class FloatsProxy extends Proxy implements Floats {
	...
	protected FloatsProxy(Floats other, int ... dims) {
		super(other, dims);
...
//		}
	...
	@Override
	public void set(final float value, int ... dims) {
	...
	public FloatsProxy copy() {
		return new FloatsProxy(matrix.copy(), fixeDimensions);
	}
