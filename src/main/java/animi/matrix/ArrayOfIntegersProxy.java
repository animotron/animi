 ...
 *
 */
public class ArrayOfIntegersProxy extends Proxy implements ArrayOfIntegers {
	...
	ArrayOfIntegers matrix;
	
	protected ArrayOfIntegersProxy(ArrayOfIntegers other, int ... dims) {
		super(other, dims);
...
//		}
	...
	public ArrayOfIntegersProxy copy() {
		return new ArrayOfIntegersProxy(matrix.copy(), fixeDimensions);
	}
